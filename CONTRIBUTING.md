...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/aeromux/aeromux-db.git
   ```
...
- Check if the bug has already been reported in [Issues](https://github.com/aeromux/aeromux-db/issues).
